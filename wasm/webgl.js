...
";
  ...
  let fragment_shader = g_gl.createShader(g_gl.FRAGMENT_SHADER);
  g_gl.shaderSource(fragment_shader,str_fs);
...
";
  ...
  let vertex_shader = g_gl.createShader(g_gl.VERTEX_SHADER);
  g_gl.shaderSource(vertex_shader,str_vs);
...
function use_shader_program() {
  ...
  g_model_proj_matrix  = g_gl.getUniformLocation(g_shader_program,'model_proj_matrix');
...
//g_gl.scissor(a_x,a_y,a_w,a_h);
  ...
  let ID4 = mat4.create();
  mat4.identity(ID4);
  g_gl.uniformMatrix4fv(g_model_proj_matrix,false,ID4);
...
function ldmatmp(a_vals) {
  g_gl.uniformMatrix4fv(g_model_proj_matrix,false,mat4.create(a_vals));
}
...
function get_rgbas(a_w,a_h) {  //gl.drawingBufferWidth,gl.drawingBufferHeight
  let pixels = new Uint8Array(a_w*a_h*4);
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
function set_gl_canvas_cursor(a_style) {
