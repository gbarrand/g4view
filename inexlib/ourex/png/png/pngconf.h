...
/* G.Barrand : none of what is in the config.h does not seem to be used ! */
...
#if __GNUC__ >=4 && __GNUC_MINOR__ >=0 && __GNUC_PATCHLEVEL__ >=1
/* Leopard comes with a g++-4.0.1 */
/* Snow Leopard comes with a g++-4.2.1 */
