...
public: // with description
  ...
  public:
    ...
    { 
      ...
      G4String errmsg = "iOS : system() not available..";
      G4Exception("G4RunManager::SetRandomNumberStoreDir","Run0071",JustWarning,errmsg);
#else
      G4String dirStr = dir;
    ...
    inline const G4String& GetRandomNumberStatusForThisEvent() const
    {
      ...
      { G4Exception("G4RunManager::SetRandomNumberStoreDir",
                    "Run0072",JustWarning,
