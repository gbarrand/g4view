...
#line 1 "../inlib/yacc/cexpr_lexer.l"
#line 2 "../inlib/yacc/cexpr_lexer.l"
...
static  int cexpr_lexer__get_next_buffer(inlib::yacc::cexpr_lexer&);

extern int cexpr_lexer_lex(inlib::yacc::cexpr_lexer&);

#define YY_DECL int cexpr_lexer_lex(inlib::yacc::cexpr_lexer& aLexer)
...
#line 62 "../inlib/yacc/cexpr_lexer.l"
...
case 1:
YY_RULE_SETUP
#line 65 "../inlib/yacc/cexpr_lexer.l"
/* ignore whitespace */;
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 67 "../inlib/yacc/cexpr_lexer.l"
{ 
#ifdef DEBUG
  ...
  if(sscanf(cexpr_lexer_text,"0x%x",&i)!=1) {
    aLexer.out() << "inlib::yacc::cexpr_lexer :"
...
case 3:
YY_RULE_SETUP
#line 84 "../inlib/yacc/cexpr_lexer.l"
{ 
#ifdef DEBUG
  aLexer.out() << "debug : Lexer.l : integer :" << cexpr_lexer_text << "|" << std::endl;
#endif
...
case 4:
YY_RULE_SETUP
#line 107 "../inlib/yacc/cexpr_lexer.l"
{
#ifdef DEBUG
...
case 5:
YY_RULE_SETUP
#line 122 "../inlib/yacc/cexpr_lexer.l"
return T_PI;
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 123 "../inlib/yacc/cexpr_lexer.l"
return T_TRUE;
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 124 "../inlib/yacc/cexpr_lexer.l"
return T_FALSE;
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 126 "../inlib/yacc/cexpr_lexer.l"
{
#ifdef DEBUG
...
case 9:
YY_RULE_SETUP
#line 135 "../inlib/yacc/cexpr_lexer.l"
{
#ifdef DEBUG
...
case 10:
YY_RULE_SETUP
#line 149 "../inlib/yacc/cexpr_lexer.l"
return cexpr_lexer_text[0];
	YY_BREAK
case 11:
YY_RULE_SETUP
#line 151 "../inlib/yacc/cexpr_lexer.l"
ECHO;
	YY_BREAK
 ...
 */
static int cexpr_lexer__get_next_buffer(inlib::yacc::cexpr_lexer& aLexer)
{
